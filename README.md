...
Tedile is the parent repository for multiple projects.
...
Create a GitHub repository named `Tedile`, then push this repository:

```bash
git remote add origin https://github.com/YOUR_USERNAME/Tedile.git
git branch -M main
